...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, kimi, pi, gemini];
...
export { claude, codex, factory, kiro, opencode, slate, cursor, openclaw, hermes, gbrain, kimi, pi, gemini };
